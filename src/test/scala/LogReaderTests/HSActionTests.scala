...
class HSActionTests extends FlatSpec with Matchers {
  ...
  "HSAction FriendlyCardDrawn" should "ExecuteAction" in {
    ...
    val friendlyHSAction = new CardDrawn("Friendly Hand 7", 7, 7, 1)
  ...
  "HSAction EnemyCardDrawn" should "ExectueAction" in{
    ...
    val hsAction = new CardDrawn(Constants.STRING_UNINIT,27, 2, 7)
  ...
  "HSAction Transform" should "ExecuteAction" in{
    val friendlyHandHSAction = new Transform(3, 3, 100)
    val friendlyBoardHSAction = new Transform(12, 2, 101)
    val enemyHandHSAction = new Transform(21, 1, 102)
    val enemyBoardHSAction = new Transform(33, 3, 103)
